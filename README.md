...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/division369/AmeowV4/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](loadstring(game:HttpGet("https://raw.githubusercontent.com/division369/AmeowV4/main/NewMainScript.lua", true))())
